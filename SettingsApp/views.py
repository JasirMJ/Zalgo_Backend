...
settings_list = [
    ...
    SettingsModel(data_type="TEXT",field_name='xcrypto URL',value="https://www.google.com",description="URL for crypto",is_active=1),
    SettingsModel(data_type="TEXT",field_name='xstock URL',value="https://www.google.com",description="URL for stock",is_active=1),
    SettingsModel(data_type="TEXT",field_name='xforex URL',value="https://www.google.com",description="URL for forex",is_active=1),

    SettingsModel(data_type="TEXT", field_name='xjoin_community URL', value="https://www.google.com",
